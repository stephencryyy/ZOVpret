...
- Последовательное тестирование **20** различных стратегий обхода DPI
- HTTPS-проверка доступности YouTube, X (Twitter), Instagram (Meta CDN)
- Автоматическое сохранение рабочей стратегии
- Прогрессбар и статус каждой попытки в реальном времени

### 🔧 20 стратегий обхода из Flowseal v1.9.7b
Поддержка полного пула конфигураций, включая:
| Категория | Техника | Описание |
|-----------|---------|----------|
| **General / ALT** | multisplit, seqovl, md5sig, hopbyhop | Базовые и альтернативные конфигурации |
| **FAKE TLS AUTO** | multidisorder, rnd, dupsid, sni | Максимальная обфускация и маскировка под TLS |
| **SIMPLE FAKE** | fake, badseq | Минимальное воздействие, высокая скорость |

*(Полный список доступен в панели настроек)*

### ✈️ Интеграция Telegram Desktop [НОВОЕ]
- Встроенный локальный MTProto WebSocket прокси (на базе [tg-ws-proxy](https://github.com/Flowseal/tg-ws-proxy))
- Управление прокси прямо с главного экрана
- Копирование `secret` и кнопка быстрого перехода (`tg://proxy?...`) для автоматической настройки Telegram Desktop

### 🎨 Премиальный UI 
- Компактное окно 420×680px (стиль VPN-приложения)
- Тёмная тема с glassmorphism, неоновым свечением и плавной анимацией
- Анимированная кнопка с SVG-кольцом прогресса
- Slide-in панель настроек для продвинутого управления
- Специальные возможности: полная навигация с клавиатуры (`focus-visible`), поддержка `prefers-reduced-motion`

### 📦 Автоматическое обновление
- Проверка последнего релиза Flowseal на GitHub
- Скачивание и распаковка бинарников (winws.exe, WinDivert, TgWsProxy_windows.exe)
- Обновление списков доменов и CDN-узлов
...
<img src="screenshot.png" alt="ZOVpret — Главный экран" width="420" />

*Компактный интерфейс с интегрированным Telegram WS прокси*
